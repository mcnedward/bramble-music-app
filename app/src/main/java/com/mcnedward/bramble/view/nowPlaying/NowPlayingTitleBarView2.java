 ...
 */
public class NowPlayingTitleBarView2 extends LinearLayout implements MediaChangeListener, IScrollView {
    ...
    public NowPlayingTitleBarView2(Context context, Song song) {
        super(context);
        initialize(context);
        update(song, null);
    }

    public NowPlayingTitleBarView2(Context context, AttributeSet attrs) {
        super(context);
        initialize(context);
    }
    ...
    public void update(Song song, Album album) {
        if (song == null) {
            song = MediaCache.getSong(mContext);    // TODO Hmmmm....
        }
